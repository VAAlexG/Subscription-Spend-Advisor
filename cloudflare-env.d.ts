/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 835dd62099a37c19b8ee744782fba997)
...
interface __BaseEnv_CloudflareEnv {
	...
	AUTH_MODE: "access";
	FIRM_ID: "firm_va";
	FIRM_NAME: "Versatile Accounting";
	INITIAL_ADMIN_EMAIL: "alexg@versatileaccounting.com.au";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "FIRM_ID" | "FIRM_NAME" | "INITIAL_ADMIN_EMAIL">> {}
}
